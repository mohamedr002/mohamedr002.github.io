...
Labeled data is scarce and expensive in many real-world time series applications. This project develops **self-supervised, semi-supervised, and federated learning** methods that maximize performance with minimal labeled data.
...
- [TS-TCC](https://github.com/emadeldeen24/TS-TCC) -- Self-supervised contrastive learning for time series
- [AdaTime](https://github.com/emadeldeen24/AdaTime) -- Benchmarking suite for time series domain adaptation

---

**Demo videos coming soon** -- We are preparing demonstrations of our self-supervised learning pipelines and benchmarking tools.
